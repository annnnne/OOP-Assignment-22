...
public class Bee extends Visual
{
    ...
    int getRandomColor()
    {
        ...
        return color(c, random(255), random(255));
    }//end getRandomColor()
    ...
    void render()
    {
        ...
        bee.text("Press any key for a flower explosion!", width/3, height/5);
        bee.popMatrix();
        ...
        if(bee.keyPressed == true)
        {
            for(int i = 0; i <10 ; i++)
            {
               ...
               drwFlr(random(width), random(height), 25); 
            }
